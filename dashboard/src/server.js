...
if (inDev) {
  ...
  config.IOT_CONN_STR = `HOSTNAME=${process.env.IOT_HOST_NAME};SHARED_ACCESS_KEY_NAME=${process.env.IOT_SHARED_ACCESS_KEY_NAME};SHARED_ACCESS_KEY=${process.env.IOT_SHARED_ACCESS_KEY}`
