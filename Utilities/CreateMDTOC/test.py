...
def get_indent_lvl_from_banner_hashes_should_return_correct_lvl_from_good_lines():
  # Arrange
  lines = ["# main", "## main2", "### main3", "#### main4", "##### main5", "###### main6"]
  results_array = []
  ...
  try:
    ...
    print("get_indent_lvl_from_banner_hashes_should_return_correct_lvl_from_good_lines")
    print(results_array)
    print(expected_results)
  return
...
def get_indent_lvl_from_banner_hashes_should_return_0_when_lines_not_appropriate():
  ...
  try:
    ...
    print("get_indent_lvl_from_banner_hashes_should_return_0_when_lines_not_appropriate")
    print(results_array)
    print(expected_results)
  return
...
def create_indent_should_return_error_string_if_indent_lvl_0():
  ...
  indent_levels = [0]
  results_array = []
  expected_array = ["ERROR - THERE WAS AN ERROR WITH THIS LINE'S INDENT LVL, LIKELY NO HASHES IN THE GIVEN LINE OR TOO MANY HASHES (max 4)!"]
...
def remove_punctuation_should_return_without_any_punctuation_when_punctuation_present():
  ...
  try:
    ...
    print("remove_punctuation_should_return_without_any_punctuation_when_punctuation_present")
    print(results_array)
    print(expected_array)
  return
...
def remove_punctuation_should_return_same_as_input_when_no_punctuation_present():
  ...
  try:
    ...
    print("remove_punctuation_should_return_same_as_input_when_no_punctuation_present")
    print(results_array)
    print(expected_array)
  return
...
def convert_spaces_to_dashes_should_convert_spaces_to_dashes_when_spaces_present():
  lines = ["main title", "main2 title", "main3ti tile", "main4 ti t i l e", "m-ain_5 - the reckoning", "main 2"]
  results_array = []
  expected_array = ["main-title", "main2-title", "main3ti-tile", "main4-ti-t-i-l-e", "m-ain_5---the-reckoning", "main-2"]
  ...
  try:
    ...
    print("convert_spaces_to_dashes_should_convert_spaces_to_dashes_when_spaces_present")
    print(results_array)
    print(expected_array)
  return
...
def convert_spaces_to_dashes_should_not_convert_anything_to_dashes_when_no_spaces_present():
  ...
  try:
    ...
    print("convert_spaces_to_dashes_should_not_convert_anything_to_dashes_when_no_spaces_present")
    print(results_array)
    print(expected_array)
  return
...
def create_full_line_should_create_good_lines_when_input_good():
  ...
  lines = ["# Main", "## main 2", "### MAIN3", "#### maIn4 the prequel"]
  results_array = []
  expected_array = ["  - [Main](#main)","    - [main 2](#main-2)","      - [MAIN3](#main3)","        - [maIn4 the prequel](#main4-the-prequel)"]
...
def create_TOC_should_create_good_toc_array_when_input_good():
  ...
  lines = [["# Main", "## main 2", "this is a dummy line", "### MAIN3", "this is another dummy line","#### maIn4 the prequel"]]
  results_array = []
  expected_array = [["  - [Main](#main)","    - [main 2](#main-2)","      - [MAIN3](#main3)","        - [maIn4 the prequel](#main4-the-prequel)"]]
...
def create_TOC_when_line_ends_with_a_hash():
  # Arrange
  input_array = [" #"]
  expected_results = [[]] # In this case, we actually want nothing returned so we want an empty list to be the output.
  results_array = []
...
def detect_back_ticks_in_line_should_return_true_when_backticks_present():
  # Arrange
  input_array = ["`", " `", "woehfowfewf`dsofosidjf`", "`hello`", "#`hello`","`#hello`","`1234`","`12`34", "13`24"]
...
def detect_back_ticks_in_line_should_return_false_when_backticks_not_present():
  # Arrange
  input_array = ["", " ", "woehfowfewfdsofosidjf", "hello", "#hello","#hello","1234","12 34", "13 24"]
  ...
  try:
    ...
    print("detect_back_ticks_in_line_should_return_false_when_backticks_not_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def remove_back_ticked_hashes_should_remove_hashes_within_backticks_when_present():
  # Arrange
  input_array = ["`#hello`", "`#`", " `#hello`", "something `#hello`", "something `# hello`", " something `#hello`", " #`#hello`", " # `# hello`"]
  expected_results = ["`hello`", "``", " `hello`", "something `hello`", "something ` hello`", " something `hello`", " #`hello`", " # ` hello`"]
  results_array = []
  ...
  try:
    ...
    print("remove_back_ticked_hashes_should_remove_hashes_within_backticks_when_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def remove_back_ticked_hashes_should_not_touch_line_when_hash_within_backtick_not_present():
  ...
  try:
    ...
    print("remove_back_ticked_hashes_should_not_touch_line_when_hash_within_backtick_not_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def remove_multiline_back_ticked_blocks_should_remove_backticked_blocks_when_backticked_blocks_present():
  ...
  try:
    ...
    print("remove_multiline_back_ticked_blocks_should_remove_backticked_blocks_when_backticked_blocks_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def remove_multiline_back_ticked_blocks_should_not_remove_backticked_blocks_when_backticked_blocks_not_present():
  ...
  try:
    ...
    print("remove_multiline_back_ticked_blocks_should_not_remove_backticked_blocks_when_backticked_blocks_not_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def handle_code_segments_should_remove_backtick_hashes_when_backtick_hashes_present():
  ...
  try:
    ...
    print("handle_code_segments_should_remove_backtick_hashes_when_backtick_hashes_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def handle_code_segments_should_remove_backtick_blocks_when_backtick_blocks_present():
  ...
  try:
    ...
    print("handle_code_segments_should_remove_backtick_blocks_when_backtick_blocks_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def handle_code_segments_should_not_remove_hashes_when_backtick_hashes_and_backtick_blocks_not_present():
  ...
  try:
    ...
    print("handle_code_segments_should_not_remove_hashes_when_backtick_hashes_and_backtick_blocks_not_present")
    print("RESULTS  =>", results_array)
    print("EXPECTED =>", expected_results)
  return
...
def function_name_should_expected_behaviour_when_condition():
  ...
  expected_results = [] # Manually worked out correct results to confirm efficacy against
  ...
  for var in input_array: # Iterate through the inputs
    ...
    results_array.append(main.get_indent_lvl_from_banner_hashes(var)) # ... giving the tested function the item you want.
  ...
  try:
    assert results_array == expected_results # Confirm that the results match what we want
  except:
    print("function_name_should_expected_behaviour_when_condition") # Same as the test name so that we can easily see which test failed.
    print("RESULTS  =>", results_array)      # Note the => ends at the same point, enabling easy side-by-side comparison of failed results
    print("EXPECTED =>", expected_results)  # Note the => ends at the same point, enabling easy side-by-side comparison of failed results
  return
